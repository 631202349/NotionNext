...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '我是DaoWong，欢迎来到我的交易室,开始你的交易之旅',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'DaoWong', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '5年交易经验，全职交易者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'daowongtrading.club', // 网站地址
  ...
  // 鼠标跟随特效
  MOUSE_FOLLOW: process.env.NEXT_PUBLIC_MOUSE_FOLLOW || fasle, // 开关
  // 这两个只有在鼠标跟随特效开启时才生效
